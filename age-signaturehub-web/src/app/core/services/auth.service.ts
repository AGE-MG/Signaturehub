...
import { ChangePasswordRequest, LoginRequest, LoginResponse, NotificationCapabilities, RegisterRequest, User } from "../models/user.model";
...
export class AuthService {
  ...
  getNotificationCapabilities(): Observable<ApiResponse<NotificationCapabilities>> {
    return this.http.get<ApiResponse<NotificationCapabilities>>(`${this.API_URL}/notification-capabilities`);
  }
